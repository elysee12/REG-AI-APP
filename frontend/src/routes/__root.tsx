...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "REG Infrastructure Protection" },
      ...
      { name: "author", content: "REG" },
      { property: "og:title", content: "REG Infrastructure Protection" },
      ...
      { name: "twitter:site", content: "@REG" },
      { name: "twitter:title", content: "REG Infrastructure Protection" },
